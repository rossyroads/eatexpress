...
public class RestaurantJpaEntity {
    ...
    public RestaurantJpaEntity(UUID owner, String name, String cuisineType, String contactEmail, String pictureUrl,
            String street, Integer street_number, String postalCode, String city, String country,
            Integer defaultPreparationTimeMinutes, PriceRange priceRange, RestaurantStatus openingStatusOverride) {
        this.owner = owner;
        this.name = name;
    ...
    public RestaurantJpaEntity(UUID owner, String name, String cuisineType, String contactEmail, String pictureUrl,
            String street, Integer street_number, String postalCode, String city, String country,
            Integer defaultPreparationTimeMinutes, PriceRange priceRange, List<DailyScheduleJpaEntity> openingHours,
