...
public class RestaurantController {
    ...
    public ResponseEntity<RestaurantDto> createRestaurant(@RequestBody RestaurantDto restaurantDto){
        CreateRestaurantCommand createRestaurantCommand = new CreateRestaurantCommand(restaurantDto.getName(),CuisineType.fromDisplayName(restaurantDto.getCuisineType()),new Email(restaurantDto.getContactEmail()),new Url(restaurantDto.getPictureUrl()),restaurantDto.getStreet(),restaurantDto.getStreet_number(),restaurantDto.getPostalCode(),restaurantDto.getCity(),restaurantDto.getCountry(),restaurantDto.getDefaultPreparationTimeMinutes(),new OpeningHours(null));
        // DtoMapper.INSTANCE.mapOpeningHours(restaurantDto.getOpeningHours()

        Restaurant newRestaurant = createRestaurantUseCase.createRestaurant(createRestaurantCommand);
